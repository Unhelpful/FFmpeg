...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--disable-postproc --disable-muxers --disable-hwaccels --disable-devices --disable-encoders --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-ffserver --disable-swscale --disable-avdevice --disable-avfilter --target-os=linux --sysroot=/opt/android-ndk/platforms/android-9/arch-arm --arch=arm --enable-cross-compile --disable-iwmmxt --cross-prefix=/opt/android-ndk/toolchains/arm-linux-androideabi-4.4.3/prebuilt/linux-x86/bin/arm-linux-androideabi- --extra-cflags='-mandroid -march=armv4t -mtune=arm920t -D__ARM_ARCH_4T__'
prefix=/usr/local
