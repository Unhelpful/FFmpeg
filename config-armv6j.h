...
#define FFMPEG_CONFIGURATION "--disable-postproc --disable-muxers --disable-hwaccels --disable-devices --disable-encoders --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-ffserver --disable-swscale --disable-avdevice --disable-avfilter --target-os=linux --arch=arm --enable-cross-compile --disable-iwmmxt --cross-prefix=/opt/android-ndk/toolchains/arm-linux-androideabi-4.4.3/prebuilt/linux-x86/bin/arm-linux-androideabi- --extra-ldflags='-L/opt/android-ndk/platforms/android-9/arch-arm/usr/lib --sysroot=/opt/android-ndk/platforms/android-9/arch-arm' --extra-cflags='-I/opt/android-ndk/platforms/android-9/arch-arm/usr/include -mthumb -march=armv6j -mtune=arm1136jf-s -pipe -fomit-frame-pointer -D__ARM_ARCH_5__ -D__ARM_ARCH_5T__ -D__ARM_ARCH_5E__ -D__ARM_ARCH_5TE__'"
