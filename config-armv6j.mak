...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--disable-protocols --disable-filters --disable-postproc --disable-muxers --disable-hwaccels --disable-devices --disable-encoders --disable-ffmpeg --disable-ffplay --disable-ffserver --disable-swscale --disable-avdevice --disable-avfilter --target-os=linux --sysroot=/opt/android-ndk/platforms/android-9/arch-arm --enable-thumb --arch=arm --enable-cross-compile --disable-iwmmxt --cross-prefix=/opt/android-ndk/toolchains/arm-linux-androideabi-4.4.3/prebuilt/linux-x86/bin/arm-linux-androideabi- --extra-cflags='-mandroid -march=armv6j -mtune=arm1136jf-s -pipe -fomit-frame-pointer -D__ARM_ARCH_5__ -D__ARM_ARCH_5T__ -D__ARM_ARCH_5E__ -D__ARM_ARCH_5TE__'
prefix=/usr/local
...
ARCH=arm
DEPCC=/opt/android-ndk/toolchains/arm-linux-androideabi-4.4.3/prebuilt/linux-x86/bin/arm-linux-androideabi-gcc
YASM=yasm
YASMDEP=yasm
CP=cp -p
LN_S=ln -sf
STRIP=/opt/android-ndk/toolchains/arm-linux-androideabi-4.4.3/prebuilt/linux-x86/bin/arm-linux-androideabi-strip
FFCPPFLAGS=  -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -D_POSIX_C_SOURCE=200112 -D_XOPEN_SOURCE=600 -DPIC
FFCFLAGS= -mandroid -march=armv6j -mtune=arm1136jf-s -pipe -fomit-frame-pointer -D__ARM_ARCH_5__ -D__ARM_ARCH_5T__ -D__ARM_ARCH_5E__ -D__ARM_ARCH_5TE__  -std=c99 -fomit-frame-pointer -fPIC -mthumb -g -Wdeclaration-after-statement -Wall -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wno-pointer-sign -Wcast-qual -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=implicit-function-declaration -Werror=missing-prototypes
FFASFLAGS= -mandroid -march=armv6j -mtune=arm1136jf-s -pipe -fomit-frame-pointer -D__ARM_ARCH_5__ -D__ARM_ARCH_5T__ -D__ARM_ARCH_5E__ -D__ARM_ARCH_5TE__  -fPIC -g
AS_O=-o $@
CC_O=-o $@
FFLDFLAGS=  -Wl,--as-needed -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil
FFFFSERVERLDFLAGS=-Wl,-E
FFSHFLAGS=-shared -Wl,-soname,$$(@F) -Wl,-Bsymbolic -Wl,--version-script,$(SUBDIR)lib$(NAME).ver
FFYASMFLAGS=
BUILDSUF=
...
EXESUF=
EXTRA_VERSION=
FFDEPFLAGS=$(CPPFLAGS) $(CFLAGS) -MM
CCDEP=
ASDEP=
FFCC_DEPFLAGS=-MMD -MF $(@:.o=.d) -MT $@
FFAS_DEPFLAGS=-MMD -MF $(@:.o=.d) -MT $@
HOSTCC=gcc
FFHOSTCFLAGS=-D_ISOC99_SOURCE -O3 -g -std=c99 -Wall
HOSTEXESUF=
FFHOSTLDFLAGS=
HOSTLIBS=-lm
TARGET_EXEC=
...
ACODEC_TESTS=aref 
VCODEC_TESTS=dnxhd_720p_10bit flashsv2 msvideo1 qtrle qtrlegray vref 
LAVF_TESTS=voc_s16 
